...
const ::std::string __RoboCompIrObjetivo__IrObjetivo__getDistancia_name = "getDistancia";

const ::std::string __RoboCompIrObjetivo__IrObjetivo__esVisible_name = "esVisible";
...
::Ice::Float
IceProxy::RoboCompIrObjetivo::IrObjetivo::getDistancia(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __RoboCompIrObjetivo__IrObjetivo__getDistancia_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
        try
        {
            __checkTwowayOnly(__RoboCompIrObjetivo__IrObjetivo__getDistancia_name);
            __delBase = __getDelegate(false);
            ::IceDelegate::RoboCompIrObjetivo::IrObjetivo* __del = dynamic_cast< ::IceDelegate::RoboCompIrObjetivo::IrObjetivo*>(__delBase.get());
            return __del->getDistancia(__ctx, __observer);
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
            __handleExceptionWrapper(__delBase, __ex, __observer);
...
::Ice::AsyncResultPtr
IceProxy::RoboCompIrObjetivo::IrObjetivo::begin_getDistancia(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    __checkAsyncTwowayOnly(__RoboCompIrObjetivo__IrObjetivo__getDistancia_name);
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __RoboCompIrObjetivo__IrObjetivo__getDistancia_name, __del, __cookie);
    try
    {
        __result->__prepare(__RoboCompIrObjetivo__IrObjetivo__getDistancia_name, ::Ice::Normal, __ctx);
        __result->__writeEmptyParams();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
::Ice::Float
IceProxy::RoboCompIrObjetivo::IrObjetivo::end_getDistancia(const ::Ice::AsyncResultPtr& __result)
{
    ::Ice::AsyncResult::__check(__result, this, __RoboCompIrObjetivo__IrObjetivo__getDistancia_name);
    ::Ice::Float __ret;
...
bool
IceProxy::RoboCompIrObjetivo::IrObjetivo::esVisible(::Ice::Int tag, const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __RoboCompIrObjetivo__IrObjetivo__esVisible_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
        try
        {
            __checkTwowayOnly(__RoboCompIrObjetivo__IrObjetivo__esVisible_name);
            __delBase = __getDelegate(false);
            ::IceDelegate::RoboCompIrObjetivo::IrObjetivo* __del = dynamic_cast< ::IceDelegate::RoboCompIrObjetivo::IrObjetivo*>(__delBase.get());
            return __del->esVisible(tag, __ctx, __observer);
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
            __handleExceptionWrapper(__delBase, __ex, __observer);
...
::Ice::AsyncResultPtr
IceProxy::RoboCompIrObjetivo::IrObjetivo::begin_esVisible(::Ice::Int tag, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    __checkAsyncTwowayOnly(__RoboCompIrObjetivo__IrObjetivo__esVisible_name);
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __RoboCompIrObjetivo__IrObjetivo__esVisible_name, __del, __cookie);
    try
    {
        __result->__prepare(__RoboCompIrObjetivo__IrObjetivo__esVisible_name, ::Ice::Normal, __ctx);
        ::IceInternal::BasicStream* __os = __result->__startWriteParams(::Ice::DefaultFormat);
        __os->write(tag);
        __result->__endWriteParams();
        __result->__send(true);
...
bool
IceProxy::RoboCompIrObjetivo::IrObjetivo::end_esVisible(const ::Ice::AsyncResultPtr& __result)
{
    ::Ice::AsyncResult::__check(__result, this, __RoboCompIrObjetivo__IrObjetivo__esVisible_name);
    bool __ret;
    bool __ok = __result->__wait();
    try
    {
...
::Ice::Float
IceDelegateM::RoboCompIrObjetivo::IrObjetivo::getDistancia(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __RoboCompIrObjetivo__IrObjetivo__getDistancia_name, ::Ice::Normal, __context, __observer);
    __og.writeEmptyParams();
    bool __ok = __og.invoke();
    ::Ice::Float __ret;
    try
...
bool
IceDelegateM::RoboCompIrObjetivo::IrObjetivo::esVisible(::Ice::Int tag, const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __RoboCompIrObjetivo__IrObjetivo__esVisible_name, ::Ice::Normal, __context, __observer);
    try
    {
        ::IceInternal::BasicStream* __os = __og.startWriteParams(::Ice::DefaultFormat);
        __os->write(tag);
...
::Ice::Float
IceDelegateD::RoboCompIrObjetivo::IrObjetivo::getDistancia(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->getDistancia(_current);
            return ::Ice::DispatchOK;
        }
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __RoboCompIrObjetivo__IrObjetivo__getDistancia_name, ::Ice::Normal, __context);
    ::Ice::Float __result;
    try
    {
...
bool
IceDelegateD::RoboCompIrObjetivo::IrObjetivo::esVisible(::Ice::Int tag, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(bool& __result, ::Ice::Int __p_tag, const ::Ice::Current& __current) : 
            ::IceInternal::Direct(__current),
            _result(__result),
            _m_tag(__p_tag)
        {
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->esVisible(_m_tag, _current);
            return ::Ice::DispatchOK;
        }
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __RoboCompIrObjetivo__IrObjetivo__esVisible_name, ::Ice::Normal, __context);
    bool __result;
    try
    {
        _DirectI __direct(__result, tag, __current);
        try
        {
            __direct.getServant()->__collocDispatch(__direct);
        }
...
::Ice::DispatchStatus
RoboCompIrObjetivo::IrObjetivo::___getDistancia(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
    __inS.readEmptyParams();
    ::Ice::Float __ret = getDistancia(__current);
...
::Ice::DispatchStatus
RoboCompIrObjetivo::IrObjetivo::___esVisible(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
    ::IceInternal::BasicStream* __is = __inS.startReadParams();
    ::Ice::Int tag;
    __is->read(tag);
    __inS.endReadParams();
    bool __ret = esVisible(tag, __current);
    ::IceInternal::BasicStream* __os = __inS.__startWriteParams(::Ice::DefaultFormat);
    __os->write(__ret);
    __inS.__endWriteParams(true);
    return ::Ice::DispatchOK;
...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__RoboCompIrObjetivo__IrObjetivo_all, __RoboCompIrObjetivo__IrObjetivo_all + 11, current.operation);
    if(r.first == r.second)
    {
    ...
    switch(r.first - __RoboCompIrObjetivo__IrObjetivo_all)
    {
        ...
        case 1:
        {
            return ___esVisible(in, current);
        }
        case 2:
        {
            return ___getDistancia(in, current);
        }
        case 3:
        {
